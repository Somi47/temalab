 ...
 * </p>
 * <ul>
 *   <li>{@link resource_conflict.components.model.impl.ComponentImpl#getTasks <em>Tasks</em>}</li>
 *   <li>{@link resource_conflict.components.model.impl.ComponentImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentImpl extends MinimalEObjectImpl.Container implements Component {
	...
	public EList<Task> getTasks() {
		if (tasks == null) {
			tasks = new EObjectContainmentEList<Task>(Task.class, this, ModelPackage.COMPONENT__TASKS);
		}
		return tasks;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ModelPackage.COMPONENT__TASKS:

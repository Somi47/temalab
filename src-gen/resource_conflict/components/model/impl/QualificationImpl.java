 ...
 * </p>
 * <ul>
 *   <li>{@link resource_conflict.components.model.impl.QualificationImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class QualificationImpl extends MinimalEObjectImpl.Container implements Qualification {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.QUALIFICATION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.QUALIFICATION__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModelPackage.QUALIFICATION__NAME:
			return getName();
		}

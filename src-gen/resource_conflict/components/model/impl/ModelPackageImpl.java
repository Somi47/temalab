...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage {
	 ...
	 * @see resource_conflict.components.model.ModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getTask_QualificationsRequired() {
	 ...
	 * @generated
	 */
	public EReference getTask_RequirementsToStart() {
	 ...
	 * @generated
	 */
	public EReference getPerson_Qualifications() {
	 ...
	 * @generated
	 */
	public EReference getPerson_Assignment() {
	 ...
	 * @generated
	 */
	public EAttribute getAssignment_From() {
	 ...
	 * @generated
	 */
	public EReference getAssignment_Person() {
	...
	public void createPackageContents() {
		...
		createEReference(personEClass, PERSON__QUALIFICATIONS);
		createEReference(personEClass, PERSON__ASSIGNMENT);
		...
		createEAttribute(assignmentEClass, ASSIGNMENT__FROM);
		createEAttribute(assignmentEClass, ASSIGNMENT__TO);
		createEReference(assignmentEClass, ASSIGNMENT__PERSON);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getTask_Estimate(), theXMLTypePackage.getInt(), "Estimate", null, 0, 1, Task.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTask_RequirementsToStart(), this.getTask(), null, "requirementsToStart", null, 0, -1,
				Task.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(personEClass, Person.class, "Person", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPerson_Qualifications(), this.getQualification(), null, "qualifications", null, 0, -1,
				Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPerson_Assignment(), this.getAssignment(), this.getAssignment_Person(), "assignment", null, 0,
				-1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPerson_Name(), theXMLTypePackage.getString(), "Name", null, 0, 1, Person.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(qualificationEClass, Qualification.class, "Qualification", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getQualification_Name(), theXMLTypePackage.getString(), "Name", null, 0, 1, Qualification.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(assignmentEClass, Assignment.class, "Assignment", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAssignment_From(), theXMLTypePackage.getInt(), "From", null, 0, 1, Assignment.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAssignment_To(), theXMLTypePackage.getInt(), "To", null, 0, 1, Assignment.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAssignment_Person(), this.getPerson(), this.getPerson_Assignment(), "person", null, 1, 1,
				Assignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(componentEClass, Component.class, "Component", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getComponent_Tasks(), this.getTask(), null, "tasks", null, 0, -1, Component.class, !IS_TRANSIENT,
